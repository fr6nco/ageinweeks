    ...
    return (
        <Form action="/">
            <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                    <input id="name" name="name" type="text" className="block w-full rounded-md bg-white px-3 py-2.5 text-base outline-1 outline-gray-300 border border-5 border-gray-300 placeholder:text-gray-400 focus:outline-2  focus:outline-indigo-600 sm:text-sm/6 relative transition-all duration-300 py-2.5 pl-4 pr-14 w-full dark:text-gray-950 border-gray-300 dark:bg-gray-300 dark:text-white/80 dark:border-slate-600 rounded-lg tracking-wide font-light text-sm placeholder-gray-400 bg-white focus:ring disabled:opacity-40 disabled:cursor-not-allowed focus:border-blue-500 focus:ring-blue-500/20" />
                </div>
            </div>

            <div className="sm:col-span-4">
                <label htmlFor="birthday" className="pt-4 block text-sm/6 font-medium">Birthday</label>
                <div className="mt-2">
                    <Datepicker
